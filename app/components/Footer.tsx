...
const Footer = () => {
  ...
  return (
    <div className="border-t-[0.5px] text-sm border-gray-300/50 dark:border-gray-300/10 py-8 max-sm:py-4 max-lg:px-6 mx-auto max-w-7xl flex justify-between text-gray-400 w-full">
